...
const Header = () => (
  <header className="pt-12 pb-6 px-6 text-center">
    <motion.div 
      ...
      className="w-28 h-28 bg-white dark:bg-slate-800 rounded-full mx-auto flex items-center justify-center shadow-xl mb-4 overflow-hidden border-2 border-blue-50 dark:border-slate-700"
    >
      <img 
        src="./logo.jpeg" 
        alt="Madani Logo" 
